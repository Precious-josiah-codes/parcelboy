    ...
    setup(props) {
        ...
        onMounted(() => {
            ...
            window.initMap = () => {
                ...
                // const image = require('@/assets/images/pickup.png')

                // const driverMarker = new google.maps.Marker({
                //     position: { lat: 6.5337161, lng: 3.3744218 },
                //     map: map.value,
                //     icon: image,
                //     animation: google.maps.Animation.BOUNCE
                // });
                ...
                //     destination: { lat: 6.5337161, lng: 3.3744218 },
                //     travelMode: 'DRIVING'
                // }
        ...
        // const loader = new Loader({ apiKey: 'AIzaSyBd_OY71JcrTrPeTUmS22nW-LvqCjSd15s' })
        
        // console.log('map ran')
        // let clickListener = null
        // onMounted(async () => {
        //     console.log('map ran mounted')
        //     await loader.load()
